      ...
      "items": [
        {
          "required": true,
          "type": "html",
          "content": "\u003Ccenter\u003E\r\n\u003Cdiv class=\"detect_card\" style=\"text-align: left; width: 600px; height: 500px\"\u003E\r\n  \u003Cp\u003E Всего исследование будет длиться 20-30 минут и состоять из 3 блоков, между которыми будет небольшой перерыв. \u003C\u002Fp\u003E\r\n  \u003Cp\u003E Обратите внимание на центральную стрелку и сосредоточьтесь на её направлении. Ваша задача — определить и отметить, в каком направлении указывает стрелка: \u003Cbr\u003E\r\n1. Если центральная стрелка указывает на право нажмите клавишу стрелка вправо на клавиатуре. \u003Cbr\u003E\r\n2. Если центральная стрелка указывает на лево нажмите клавишу стрелка влево на клавиатуре. \u003Cbr\u003E\r\n  \u003Cp\u003E Пожалуйста, давайте свой ответ в тот момент, когда на экране появится надпись: &quot;укажите направление центральной стрелки &quot;. \u003C\u002Fp\u003E\r\nВремя на ответ ограничено 3с.\u003Ccenter\u003E\u003Cbutton type=\"submit\" class=\"custom-btn btn-3\"\u003E\u003Cspan\u003EДалее\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003C\u002Fcenter\u003E\r\n\u003C\u002Fdiv\u003E\r\n\u003C\u002Fcenter\u003E",
          "name": ""
        }
      ],
      "scrollTop": true,
      ...
      "items": [
        {
          "required": true,
          "type": "html",
          "content": "\u003Ccenter\u003E\r\n\u003Cdiv class=\"detect_card\" style=\"text-align: left; width: 600px; height: 820px\"\u003E\r\n  \u003Cp\u003E Вам будут показываться анимации. Ваша задача ответить возник ли у вас во время просмотра анимации фи-феномен. Фи-феномен - иллюзия движения пятна, закрывающего собой элементы. Если вы ощутили движения такого пятна, Вам необходимо нажать клавишу «q» на клавиатуре. Если Вы не ощутили движения, а например, вы видите, что элементы появляются одновременно, мелькают или поочердёно мигают, Вам необходимо нажать клавишу «w» на клавиатуре. \u003C\u002Fp\u003E\r\n \r\nПример фи-феномена (необходимо отвечать возник фи-феномен):\u003Ccenter\u003E \u003Cimg src=\"embedded\u002Fphi.gif\" width=\"550px\"\u003E\u003C\u002Fcenter\u003E\r\nПример поочерёдного мигания (необходимо отвечать, что фи-феномен не возник):\u003C\u002Fp\u003E\r\n \u003Ccenter\u003E \u003Cimg src=\"embedded\u002Ffade.gif\" width=\"550px\"\u003E\u003C\u002Fcenter\u003E\r\nПример мелькания (необходимо отвечать, что фи-феномен не возник):\u003C\u002Fp\u003E\r\n \u003Ccenter\u003E \u003Cimg src=\"embedded\u002Fnot_phi.gif\" width=\"550px\"\u003E\u003C\u002Fcenter\u003E\r\n\u003Ccenter\u003E\u003Cbutton type=\"submit\" class=\"custom-btn btn-3\"\u003E\u003Cspan\u003EНачать\u003C\u002Fspan\u003E\u003C\u002Fbutton\u003E\u003C\u002Fcenter\u003E\r\n\u003C\u002Fdiv\u003E\r\n\u003C\u002Fcenter\u003E",
          "name": ""
        }
      ],
      "scrollTop": true,
                        ...
                        "items": [
                          {
                            "required": true,
                            "type": "html",
                            "content": "\u003Cdiv class=\"parent\" style=\"color: white;\"\u003E\r\n  \u003Cdiv class=\"${ 'elem' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 0)? \" \" : \" hide\") }\"\u003E${ parameters.peref_arr }\u003C\u002Fdiv\u003E\r\n  \u003Cdiv class=\"${ 'elem ' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 1)? \" \" : \" hide\") }\"\u003E${ parameters.peref_arr }\u003C\u002Fdiv\u003E\r\n  \u003Cdiv class=\"${ 'elem' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 2)? \" \" : \" hide\") }\"\u003E${ parameters.peref_arr }\u003C\u002Fdiv\u003E\r\n  \u003Cdiv class=\"${ 'elem' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 3)? \" \" : \" hide\") }\"\u003E${ parameters.center_arr }\u003C\u002Fdiv\u003E\r\n  \u003Cdiv class=\"${ 'elem' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 4)? \"\" : \" hide\") }\"\u003E${ parameters.peref_arr }\u003C\u002Fdiv\u003E\r\n  \u003Cdiv class=\"${ 'elem' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 5)? \" \" : \" hide\") }\"\u003E${ parameters.peref_arr }\u003C\u002Fdiv\u003E\r\n  \u003Cdiv class=\"${ 'elem' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 6)? \"\" : \" hide\") }\"\u003E${ parameters.peref_arr }\u003C\u002Fdiv\u003E\r\n\u003C\u002Fdiv\u003E\r\n",
                            "name": ""
                          }
                        ],
                        "scrollTop": true,
            ...
            "content": [
              {
                ...
                "strokeWidth": 1,
                "fill": "#ffffff",
                "text": "Укажите направление центральной стрелки",
                "fontStyle": "normal",
                "fontWeight": "normal",
                "fontSize": 32,
                "fontFamily": "sans-serif",
...
window.flanker_resp = this.data.response
window.flanker_rt = this.data.duration
}
            },
            "title": "flanker_resp (script)"
          },
          {
            "type": "lab.canvas.Screen",
            "content": [
              {
                ...
                "strokeWidth": 1,
                "fill": "#ffffff",
                "text": "укажите возник ли фи-феномен",
                "fontStyle": "normal",
                "fontWeight": "normal",
                "fontSize": 32,
                "fontFamily": "sans-serif",
...
this.state.flanker_resp = window.flanker_resp
this.state.flanker_rt = window.flanker_rt
