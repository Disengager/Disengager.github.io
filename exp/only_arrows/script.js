      ...
      "items": [
        {
          "required": true,
          "type": "html",
          "content": "\u003Ccenter class=\"instruction\"\u003EВ исследовании Вам предстоит решать следующую задачу :\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Chr\u003E\r\nНа экране на короткое время будет предъявляться стрелка. Необходимо определять, в каком направлении указывает стрелка. Если стрелка указывает влево («), Вам необходимо как можно быстрее нажать стрелку влево \u002F вправо на клавиатуренажать стрелку влево на клавиатуре. Если же стрелка указывает вправо (»), Вам необходимо как можно быстрее нажать стрелку вправо на клавиатуре.  ${ (window.group == 1) ? \"\" : \"\" }\r\n\u003Cbr\u003E\u003Cbr\u003E\u003Chr\u003E\r\n\u003C\u002Fcenter\u003E",
          "name": ""
        }
      ],
      "scrollTop": true,
...
function checkKey(e) {
    ...
    if (e.keyCode == '37') {  answer.value = "0"; } // left arrow
    else if (e.keyCode == '39') { answer.value = "1"; } // right arrow
    else { return false; }
