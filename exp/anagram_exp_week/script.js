...
size.off()
    ...
    },
    {
      ...
      "parameters": {},
      "messageHandlers": {},
      "title": "Основная часть (всё что в блоке - предзагружается)",
      "tardy": true,
      "content": [
        {
          "type": "lab.html.Page",
          ...
          "items": [
            {
              "required": true,
              "type": "html",
              "content": "\u003Ccenter style=\"width: 1000px; font-size: ${ sizes.get_font_size() *0.28 }px; text-align: left\"\u003E\r\n  \u003Cp\u003EПосле этого появится вопрос о других версиях ответа. Другие версии – это те слова, которые всплывали у Вас по ходу решения анаграммы, и которые Вы отвергли. Пожалуйста, называйте вслух все версии, которые возникали, а если их не было, скажите слово «нет». Нажмите стрелку вправо на клавиатуре, чтобы перейти к следующей анаграмме. \r\n\u003C\u002Fp\u003E\r\n\u003Cp\u003EУ вас будет возможность потренироваться, перед началом основного задания.  \r\n\u003Cbr\u003E\u003Cbr\u003EНажмите «ПРОБЕЛ», чтобы перейти к тренировочной части. \r\n \u003C\u002Fp\u003E\r\n\r\n\u003Cbr\u003E\u003Cbr\u003E\r\n\u003C\u002Fcenter\u003E\r\n",
              "name": ""
            }
          ],
          "scrollTop": true,
                ...
                "items": [
                  {
                    "required": true,
                    "type": "html",
                    "content": "\u003Ccenter style=\"font-size: ${ sizes.get_font_size() * 0.9142857142857143}px\"\u003E+\u003C\u002Fcenter\u003E",
                    "name": ""
                  }
                ],
                "scrollTop": true,
                      ...
                      "items": [
                        {
                          "required": true,
                          "type": "html",
                          "content": "\u003Ccenter\u003E\u003Cimg src=\"${ this.files[block[parameters.i].stimules.get_an_img(parameters.counter)] }\" width=\"${ sizes.get_font_size() * 7.3 }px\" height=\"${ sizes.get_font_size() * 7.3 }px\"\u003E\u003C\u002Fcenter\u003E",
                          "name": ""
                        }
                      ],
                      "scrollTop": true,
...
preload_image(this.files[block[this.parameters.i].stimules.get_an_img(this.parameters.counter)])
}
                      },
                      "title": "Анаграмма *код",
                      ...
                      "items": [
                        {
                          "required": true,
                          "type": "html",
                          "content": "\u003Ccenter style=\"font-size: ${ sizes.get_font_size() * 0.9142857142857143}px\"\u003EСкажите ответ\u003C\u002Fcenter\u003E ",
                          "name": ""
                        }
                      ],
                      "scrollTop": true,
                      ...
                      "items": [
                        {
                          "required": true,
                          "type": "html",
                          "content": "\u003Ccenter style=\"font-size: ${ sizes.get_font_size() * 0.9142857142857143}px\"\u003E\r\n  Назовите все версии\r\n  \u003Cbr\u003E\r\n\u003C\u002Fcenter\u003E",
                          "name": ""
                        }
                      ],
                      "scrollTop": true,
      ...
      "items": [
        {
          "required": true,
          "type": "html",
          "content": "\u003Ccenter style=\"font-size: ${sizes.get_font_size() * 0.28}px; color: white;\"\u003E\r\n\u003Cdiv style=\"text-align: left;\"\u003E\r\n  Благодарим за участие в эксперименте!\r\n\u003C\u002Fdiv\u003E\r\n\u003C\u002Fcenter\u003E",
          "name": ""
        }
      ],
      "scrollTop": true,
