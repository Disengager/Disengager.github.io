              ...
              "items": [
                {
                  "required": true,
                  "type": "html",
                  "content": "\u003Cdiv class=\"parent\"\u003E\r\n\u003Cdiv  class=\"${ 'elem el_0' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 0)? \" \" : \" hide\") }\"\u003E\u003C\u002Fdiv\u003E\r\n\u003Cdiv class=\"${ 'elem el_1' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 1)? \" \" : \" hide\") }\"\u003E\u003C\u002Fdiv\u003E\r\n\u003Cdiv class=\"${ 'elem el_2' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 2)? \" \" : \" hide\") }\"\u003E\u003C\u002Fdiv\u003E\r\n\u003Cdiv class=\"${ 'elem el_3' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 3)? \" \" : \" hide\") }\"\u003E\u003C\u002Fdiv\u003E\r\n\u003Cdiv class=\"${ 'elem el_4' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 4)? \"\" : \" hide\") }\"\u003E\u003C\u002Fdiv\u003E\r\n\u003Cdiv class=\"${ 'elem el_5' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 5)? \" \" : \" hide\") }\"\u003E\u003C\u002Fdiv\u003E\r\n\u003Cdiv class=\"${ 'elem el_6' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 6)? \"\" : \" hide\") }\"\u003E\u003C\u002Fdiv\u003E\r\n\u003Cdiv class=\"${ 'elem el_7' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 7)? \" \" : \" hide\") }\"\u003E\u003C\u002Fdiv\u003E\r\n\u003Cdiv class=\"${ 'elem el_8' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 8)? \" \" : \" hide\") }\"\u003E\u003C\u002Fdiv\u003E\r\n\u003Cdiv class=\"${ 'elem el_9' +  (parameters.elem_i != stimules.get_direction(parameters.prob_i, 9)? \" \" : \" hide\") }\"\u003E\u003C\u002Fdiv\u003E\r\n\u003C\u002Fdiv\u003E\r\n",
                  "name": ""
                }
              ],
              "scrollTop": true,
...
this.state.relax = stimules.get_by_key('relax', this.parameters.prob_i)
          ...
          },
          {
            ...
            "messageHandlers": {},
            "title": "Конец блока",
            "skip": "${ !stimules.get_by_key('relax', parameters.prob_i)}"
          }
        ]
      }
    },
