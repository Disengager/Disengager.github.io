    ...
    },
    {
      ...
      "content": [
        ...
        },
        {
          ...
          "messageHandlers": {},
          "title": "Instruction4",
          "content": "\u003Cmain class=\"content-horizontal-center\r\n               content-vertical-center w-100\" id = inst12  \u003E\r\n    \u003Cdiv\u003E\r\n\u003Cp5 style=\"text-align: center;\"\u003E Если Вы сообщите, что испытали Ага-переживание, \u003Cbr\u003E Вам будет предложено оценить его интенсивность \u003Cbr\u003Eс помощью визуальной шкалы. \u003Cbr\u003EЛевый ее полюс отражает Ага-переживание слабой интенсивности, \u003Cbr\u003Eправый – очень выраженное Ага-переживание.\u003C\u002Fp5\u003E\r\n\r\n\r\n\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Cp5\u003EБегунок всегда будет расположен слева. Вы можете передвигать его для того, \u003Cbr\u003Eчтобы дать оценку интенсивности Ага!. \u003Cbr\u003EЧтобы сохранить выбранное положение бегунка, используйте двойное нажатие. \u003Cbr\u003EПосле него бегунок сменит цвет на зеленый, \u003Cbr\u003Eчто будет означать, что Ваш ответ сохранен.   \r\n\u003C\u002Fp5\u003E\r\n\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Cp5\u003EНажмите \"Enter\", чтобы приступить к тренировке.\u003C\u002Fp5\u003E\r\n\u003C\u002Fmain\u003E\r\n"
        }
      ]
    },
    {
...
console.log(this.data)
window.ans_no_1 = this.data.sub_answer == 'нет'
}
            },
            "title": "answer",
            "timeout": "12000"
...
window.no_aha = this.data.response == '0'
            ...
            "tardy": true,
            "skip": "${window.ans_no_1 || window.ans_lose}"
          },
          {
            "type": "lab.html.Page",
            "items": [
...
document.querySelector('#slider1').addEventListener('dblclick', (e) => {
    if (e.target.id === 'fader' || e.target.closest('#slider1')) {
        ...
        setTimeout(() => {
            ...
            "title": "intensity_aha",
            "skip": "${window.no_aha || window.ans_no_1 || window.ans_lose}",
            "tardy": true
          }
        ]
      }
